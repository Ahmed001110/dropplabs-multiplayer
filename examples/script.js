const closeBtn = document.querySelectorAll('.intro_close_btn'),
  ...
  continuesignupmobileBtn = document.querySelector('.continue_btn_temp_sign_mobile'),
  continuesigninmobileBtn = document.querySelector('.continue_btn_temp_sign_in_mobile'),
